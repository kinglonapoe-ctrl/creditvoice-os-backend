...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CreditVoice OS — Credit & Voice Platform" },
      {
        name: "description",
        content:
          "Multi-tenant platform for organizations that manage customer credit accounts over the phone.",
      },
      { property: "og:title", content: "CreditVoice OS — Credit & Voice Platform" },
      {
